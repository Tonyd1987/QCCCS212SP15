...
public final class ASTHelper {
    ...
    /**
     * Creates a new {@link NameExpr} from a qualified name.<br> The qualified
     * name can contains "." (dot) characters.
     *
     ...
     * types will be initialized if it is
     * <code>null</code>.
     *
