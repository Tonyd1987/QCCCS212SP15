...
/**
 * <p> This class represents the entire compilation unit. Each java file denotes
 * a compilation unit. </p> The CompilationUnit is constructed following the
 * syntax:<br>
 * <code>
 * <table>
 * <tr valign=baseline>
 ...
 *   <td align=center>::=</td>
 *   <td align=left>
 *   ( {@link PackageDeclaration} )?<br> ( {@link ImportDeclaration} )*<br> (
 * {@link TypeDeclaration} )*<br> </td> </tr> </table>
 * </code>
 *
...
public final class CompilationUnit extends Node {
     ...
     * inner-classes and other members.<br> If there is no comment,
    ...
    /**
     * Retrieves the package declaration of this compilation unit.<br> If this
     * compilation unit has no package declaration (default package),
     * <code>null</code> is returned.
     *
    ...
    /**
     * Return the list of types declared in this compilation unit.<br> If there
     * is no types declared,
     * <code>null</code> is returned.
     *
     ...
     *
     * @param pakage the pakage declaration to set or <code>null</code> to
     * default package
     */
